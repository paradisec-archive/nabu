...
const apiKey = useKey ? document.querySelector('body').dataset.googleMapsApiKey : undefined;
...
document.querySelectorAll('.collection_map').forEach((element) => {
  ...
  coordinates.forEach((coord) => {
    ...
    const content = element.dataset.content.replace(/TITLE/g, coord.title).replace(/ID/g, coord.id).replace(/ITEMS/g, coord.items);
