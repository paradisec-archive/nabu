module Oni
  class ObjectsValidator
    ...
    SORT_FIELDS = %w[id identifier title name originated_on].freeze
    ...
    validates :entity_type, inclusion: { in: Oni::EntityType::PCDM_TYPES, message: '%{value} is not a valid conformsTo' }, allow_nil: true
