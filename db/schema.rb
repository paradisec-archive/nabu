...
ActiveRecord::Schema[7.0].define(version: 2017_09_04_034643) do
  ...
  create_table "agent_roles", id: :integer, charset: "latin1", force: :cascade do |t|
    t.string "name", null: false
  end

  create_table "collection_admins", id: :integer, charset: "latin1", force: :cascade do |t|
  ...
  create_table "collection_countries", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "country_id"
    t.index ["collection_id", "country_id"], name: "index_collection_countries_on_collection_id_and_country_id", unique: true
  end

  create_table "collection_languages", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "collection_id"
  ...
  create_table "dump_for_nick", id: false, charset: "latin1", force: :cascade do |t|
    ...
    t.text "subject_languages", size: :medium
    t.text "content_languages", size: :medium
  end

  create_table "essences", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "item_id"
    t.string "filename"
    t.string "mimetype"
    t.integer "bitrate"
  ...
  create_table "funding_bodies", id: :integer, charset: "latin1", force: :cascade do |t|
    t.string "name", null: false
    t.string "key_prefix"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "item_admins", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "item_id", null: false
    t.integer "user_id", null: false
    t.index ["item_id", "user_id"], name: "index_item_admins_on_item_id_and_user_id", unique: true
  end

  create_table "item_agents", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "item_id", null: false
    t.integer "user_id", null: false
  ...
  create_table "item_content_languages", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "item_id", null: false
    t.integer "language_id", null: false
    t.index ["item_id", "language_id"], name: "index_item_content_languages_on_item_id_and_language_id", unique: true
  end

  create_table "item_countries", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "item_id", null: false
    t.integer "country_id", null: false
    t.index ["item_id", "country_id"], name: "index_item_countries_on_item_id_and_country_id", unique: true
  end

  create_table "item_data_categories", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "item_id", null: false
  ...
  create_table "item_subject_languages", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "item_id", null: false
    t.integer "language_id", null: false
