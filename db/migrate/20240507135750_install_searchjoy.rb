class InstallSearchjoy < ActiveRecord::Migration[7.1]
  def change
    ...
    # NOTE: autogenerated name is too long
    add_index :searchjoy_searches, %i[search_type normalized_query created_at], name: 'index_searchjoy_searches_on_search_type_query'
